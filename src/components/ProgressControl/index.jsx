  ...
  return (
    <div className="pt-6 flex justify-between border-t">
      <button
        ...
        上一步</button>
      <button
        className="flex items-center py-4 px-8 rounded-lg bg-secondary text-white">
        下一步
        {/* <img src="../images/right.png" alt="" className="w-6 h-6 mr-3" /> */}
      </button>
      {/* <button className="flex items-center py-4 px-8 rounded-lg bg-secondary">確認訂單</button> */}
    </div>
  );
};
